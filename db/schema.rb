...
ActiveRecord::Schema.define(version: 2020_10_29_071122) do
  ...
  create_table "likeys", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "gossip_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gossip_id"], name: "index_likeys_on_gossip_id"
    t.index ["user_id"], name: "index_likeys_on_user_id"
  end
